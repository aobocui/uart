...
puts $bdname
append wrapperName $bdname "_wrapper"

add_files -norecurse $projpath/$projName.gen/sources_1/bd/$bdname/hdl/$wrapperName.v 
# add_files -norecurse [glob -nocomplain $projpath/$projName.srcs/sources_1/bd/$bdname/hdl/*.v]

puts $wrapperName
set_property top $wrapperName [current_fileset]
